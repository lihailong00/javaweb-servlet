...
////        testBatchInsert(10);
//        testQuery1();
//        int res = DBUtil.queryTotalCount("select count(*) from course");
//        DBUtil.executeUpdate("select * from course", null);
//        test();
    }
//    public static void test() {
//        int currentPage = 1, pageSize = 6;
...
//    }
    ...
    public static void testQuery1() {
        Map<String, Object> whereMap = new HashMap<>();
        whereMap.put("cId", "100");
        try {
            DBUtil.query("course", whereMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
